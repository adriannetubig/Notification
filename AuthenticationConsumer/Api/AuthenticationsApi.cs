...
namespace AuthenticationConsumer.Api
{
    public class AuthenticationsApi: IAuthenticationsApi
    {
        ...
        public bool Login(User user)
        {
            ...
            var response = httpClient.PostAsJsonAsync("api/Authentications/Login", user).Result;
        ...
        public Authentication Refresh(Authentication authentication)
        {
            ...
            var response = httpClient.PostAsJsonAsync("api/Authentications/Refresh", authentication).Result;
